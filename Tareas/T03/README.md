...
3. http://www.3engine.net/wp/2015/11/pyqt-como-hacer-que-qlabel-sea-clicable/: Utilizo este código para hacer clicleable un QLabel, lo cual no viene por defecto. Es utilizado para las cartas. Se encuentra entre la línea 231 a la 243 del módulo ```ventana_juego.py```.
